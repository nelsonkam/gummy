...
const tabs = [
  {
    action: (navigation) => navigation.navigate('Sales'),
    name: 'sales',
    label: 'Sales',
  ...
  {
    action: (navigation) => navigation.navigate('Products'),
    name: 'products',
    label: "Products",
  ...
  {
    action: (navigation) => navigation.navigate('Pings'),
    name: 'pings',
    label: "Pings",
  ...
  {
    action: (navigation) => Linking.openURL('mailto:nelson@sommahg.com?subject=Help'),
    name: 'support',
    label: "Support",
  ...
  return (
    <View style={styles.container}>
      <View style={styles.content}>
        {tabs.map((tab, i) => (
          <TouchableOpacity key={tab.name} onPress={() => tab.action(navigation)} style={styles.tab}>
